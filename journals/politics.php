   ...
   <body> 	
      ...
      <div class="head">
          ...
          <div class="main-nav">
              ...
              <a href="#" alt="Journal" data-toggle="tooltip" data-placement="bottom" title="Journal"><img src="../img/svg/nav-icons/journal-white.svg"></a>
    		...
    		<nav class="navbar navbar-expand-lg navbar-light bg-light">
				  ...
				  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
				    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				      ...
				      <li class="nav-item">
				        <a class="nav-link " href="life.php">Life</a>
				      </li>				      
				      <li class="nav-item">
				        <a class="nav-link " href="philosophy.php">Philosophy</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link " href="controversy.php">Controversy</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link active" href="politics.php">Politics</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link" href="self-help.php">Self Help</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link" href="economics.php">Economics</a>
				      </li>
				      <li class="nav-item">
				...
				<ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
 					<li class="nav-item">
				      <a class="nav-link p-2" href="#">
				     	<img src="../img/svg/nav-icons/shuffle-arrows.svg " width="30" height="30" alt="">
				      </a>
				    </li> 
  				</ul>
